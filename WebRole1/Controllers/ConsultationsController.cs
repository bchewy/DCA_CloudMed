...
namespace WebRole1.Controllers
{
    public class ConsultationsController : Controller
    {
        ...
        {
            var consultations = db.Consultations.Include(c => c.Patient);
        ...
        public ActionResult Create([Bind(Include = "ConsultationID,QueueNo,TimeStamp,Status,ConsultationType,PatientID")] Consultation consultation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ConsultationID,QueueNo,TimeStamp,Status,ConsultationType,PatientID")] Consultation consultation)
        {
            if (ModelState.IsValid)
            {
